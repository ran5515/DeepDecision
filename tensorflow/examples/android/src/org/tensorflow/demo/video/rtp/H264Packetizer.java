...
package org.tensorflow.demo.video.rtp;
...
public class H264Packetizer extends AbstractPacketizer implements Runnable {
	...
	private void send() throws IOException, InterruptedException {
		...
		// Large NAL unit => Split nal unit 
			...
			String h4 = String.format("%8s", Integer.toBinaryString(header[4] & 0xFF)).replace(' ', '0');
			Log.e("naluLengthh4",": " + h4);
			// Set FU-A header
			...
			while (sum < naluLength) {
				...
				String h1 = String.format("%8s", Integer.toBinaryString(header[0] & 0xFF)).replace(' ', '0');
				Log.e("naluLengthh1",": " + h1);
				String h2 = String.format("%8s", Integer.toBinaryString(header[1] & 0xFF)).replace(' ', '0');
				Log.e("naluLengthh2",": " + h2);
				String s1 = String.format("%8s", Integer.toBinaryString(buffer[rtphl] & 0xFF)).replace(' ', '0');
				Log.e("naluLengths1",": " + s1);
				String s2 = String.format("%8s", Integer.toBinaryString(buffer[rtphl+1] & 0xFF)).replace(' ', '0');
				Log.e("naluLengths2",": " + s2);
