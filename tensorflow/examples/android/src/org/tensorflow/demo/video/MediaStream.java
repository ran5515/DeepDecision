...
import org.tensorflow.demo.video.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(org.tensorflow.demo.video.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(org.tensorflow.demo.video.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link org.tensorflow.demo.video.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "org.tensorflow.demo.video-";
