...
import org.tensorflow.demo.video.audio.AACStream;
import org.tensorflow.demo.video.audio.AMRNBStream;
...
import org.tensorflow.demo.video.video.H263Stream;
import org.tensorflow.demo.video.video.H264Stream;
...
public class SessionBuilder {
	...
	public Session build() {
		...
		if (session.getVideoTrack()!=null) {
			...
			video.setDestinationPorts(16288);
		}
